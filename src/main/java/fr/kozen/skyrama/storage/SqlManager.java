...
public class SqlManager {
    ...
    private String user = (String) Skyrama
        .getPlugin(Skyrama.class)
        .getConfig()
        .get("mysql.user");
    private String host = (String) Skyrama
        .getPlugin(Skyrama.class)
        .getConfig()
        .get("mysql.host");
    private String name = (String) Skyrama
        .getPlugin(Skyrama.class)
        .getConfig()
        .get("mysql.name");
    private String password = (String) Skyrama
        .getPlugin(Skyrama.class)
        .getConfig()
        .get("mysql.password");
    private int port = (int) Skyrama
        .getPlugin(Skyrama.class)
        .getConfig()
        .get("mysql.port");
